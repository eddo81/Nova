...
class CleanWp {
  ...
  public function __construct() {
    ...
    add_action('after_setup_theme', function() {
      ...
      if(current_theme_supports('clean-up-markup')) {
        $this->clean_up_markup();
      }
  
      if(current_theme_supports('disable-asset-versioning')) {
        $this->disable_asset_versioning();
      }
  
      if(current_theme_supports('disable-trackbacks-pingbacks')) {
        $this->disable_trackbacks_pingbacks();
      }
  
      if(current_theme_supports('scripts-to-footer')) {
  ...
  */
  private function clean_up_markup() : void {
    ...
    add_filter('script_loader_tag', function($input) {
      return $input = str_replace("type='text/javascript' ", '', $input);
    });
    ...
    foreach($filters = ['get_avatar', 'comment_id_fields', 'post_thumbnail_html'] as $filter) {
  ...
  private function disable_asset_versioning() : void {
    ...
    foreach($filters = ['script_loader_src', 'style_loader_src'] as $filter) {
